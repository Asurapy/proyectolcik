...
$res = "SELECT * FROM ventasbk WHERE fecfac BETWEEN '$desde' AND '$hasta'";
...
while($productos2 = mysqli_fetch_array($productos)){
	...
	$pdf->Cell(15, 8, $item, 0);
	$pdf->Cell(70, 8,$productos2['nomcli'], 0);
	$pdf->Cell(20, 8, $productos2['pf1'], 0);
	$pdf->Cell(20, 8, $productos2['pf2'], 0);
	$pdf->Cell(20, 8, $productos2['nrodoc'], 0);
	$pdf->Cell(30, 8, 'Gs/. '.$productos2['totdoc'], 0);
	$pdf->Cell(30, 8, 'Gs/. '.$productos2['iva10'], 0);
