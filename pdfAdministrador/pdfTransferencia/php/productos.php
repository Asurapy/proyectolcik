...
$pdf->Cell(15, 8, 'Numero Trans.', 0);
$pdf->Cell(20, 8, 'Codigo de Producto', 0);
$pdf->Cell(20, 8, 'Pf1', 0);
$pdf->Cell(20, 8, 'Pf2', 0);
$pdf->Cell(20, 8, 'Num.', 0);
...
$res = "SELECT * FROM transferencia WHERE fecdoc BETWEEN '$desde' AND '$hasta'";
...
while($productos2 = mysqli_fetch_array($productos)){
	...
	$pdf->Cell(20, 8, $productos2['exiant'], 0);
	$pdf->Cell(30, 8, 'Gs/. '.$productos2['exiact'], 0);
	$pdf->Cell(30, 8, 'Gs/. '.$productos2['usuario'], 0);
	$pdf->Cell(30, 8, date('d/m/Y', strtotime($productos2['fecdoc'])), 0);
	$pdf->Ln(8);
}
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(104,8,'',0);
...
$pdf->Output('reporteTransferencia.pdf','D');
?>