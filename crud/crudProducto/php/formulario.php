...
<form role="form" method="post" action="php/actualizar.php">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" value="<?php echo $person->codigoIva; ?>" name="phone" >
  </div>
  <div class="form-group">
    <label for="sector">Codigo Sector</label>
    <input type="text" class="form-control" value="<?php echo $person->codigoSector; ?>" name="sector" >
  </div>
  <div class="form-group">
